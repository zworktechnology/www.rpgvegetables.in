...
<div class="account-content">
    <div class="login-wrapper"
        style="background-image: url({{ asset('assets/backend/img/login.jpg') }}); background-repeat: no-repeat; background-size: cover;">
                    ...
                    <div class="form-login">
                        ...
                        <div class="form-addons">
                            <input type="email" id="email"
                                class="floating form-control @error('email') is-invalid @enderror" name="email"
