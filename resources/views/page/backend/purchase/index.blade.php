            ...
            <div class="page-btn">
                <div class="row">
                    <div style="display: flex;">
                        ...
                        <a href="{{ route('purchase.create') }}" class="btn btn-added" style="margin-right: 10px;background-color: #bb332f;">Add
                            Purchase</a>
                    </div>
                </div>
            </div>
            ...
            @foreach ($allbranch as $keydata => $allbranches)
                ...
                <div class="col-lg-2 col-sm-4 col-6">
                    ...
                    <a href="#todaystock{{ $allbranches->id }}" data-bs-toggle="modal"data-id="{{ $allbranches->id }}"
                            data-bs-target=".todaystock-modal-xl{{ $allbranches->id }}" class="btn btn-added " style="color:white;background-color: #bb332f;font-size: 13px;font-weight: 600;">Current Details</a>
