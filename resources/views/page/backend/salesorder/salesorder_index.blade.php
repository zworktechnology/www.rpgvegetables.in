...
<div class="content">
    <div class="page-header">
        ...
        <div style="display: flex;">
            <form autocomplete="off" method="POST" action="{{ route('salesorder.salesorder_datefilter') }}"
                style="display: flex;">
                @method('PUT')
                @csrf
                <div style="display: flex">
        ...
        <div class="col-lg-2 col-sm-4 col-6">
            <a href="{{ route('salesorder.salesorder_index') }}">
                <div class="dash-widget" @if ($pos=="sales" )
                    style="border-color:red; background-color: red; margin-bottom:18px;" @endif>
                ...
                <table class="table  customerdatanew">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ date('h:m A', strtotime($Sales_datas['time'])) }}</td>
